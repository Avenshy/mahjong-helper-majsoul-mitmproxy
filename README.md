...
本项目用于将雀魂的牌局发到[日本麻将助手mahjong-helper](https://github.com/EndlessCheng/mahjong-helper)，基于[mitmproxy](https://github.com/mitmproxy/mitmproxy)的中间人攻击方式，支持浏览器和客户端，不支持牌谱分析。
